================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : IBarcodeReaderTest2 Project Overview
===============================================================================

The application wizard has created this IBarcodeReaderTest2 application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your IBarcodeReaderTest2 application.

IBarcodeReaderTest2.vcproj
    This is the main project file for VC++ projects generated using an application wizard. 
    It contains information about the version of Visual C++ that generated the file, and 
    information about the platforms, configurations, and project features selected with the
    application wizard.

IBarcodeReaderTest2.h
    This is the main header file for the application.  It includes other
    project specific headers and declares the CIBarcodeReaderTest2App application class.

IBarcodeReaderTest2.cpp
    This is the main application source file that contains the application
    class CIBarcodeReaderTest2App.


IBarcodeReaderTest2ppc.rc
...
res\IBarcodeReaderTest2ppc.rc2
    This file contains resources that are not edited by Microsoft 
    Visual C++. You should place all resources not editable by
    the resource editor in this file.


res\IBarcodeReaderTest2.ico
...
IBarcodeReaderTest2Dlg.h, IBarcodeReaderTest2Dlg.cpp - the dialog
    These files contain your CIBarcodeReaderTest2Dlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named IBarcodeReaderTest2.pch and a precompiled types file named StdAfx.obj.
